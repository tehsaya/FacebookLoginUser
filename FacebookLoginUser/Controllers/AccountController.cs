...
using FacebookLoginUser.Models;

namespace FacebookLoginUser.Controllers
{
    [Authorize]
...
//            //            {
//            //                client_id = "1543903945902002",
//            //                client_secret = "fd79ac8d84266a16844d034c5f4be638",
//            //                grant_type = "client_credentials"
//            //            });
//            //            var app_fb = new FacebookClient(access_token);
//            //
//            //            app_fb.AccessToken = result.access_token;
//            //            
//            //            dynamic parameters = new ExpandoObject();
//            //            parameters.message = "What ever";
//            //            parameters.href = "Home";
//            //            parameters.template = "Please use our app";
//            //Ex. dynamic myFeed = fb.Get("/me/feed");
//            //            app_fb.Post(myInfo["id"] + "/notifications", parameters);
//
...
////            var meInfo = new FacebookViewModel()
////            {
////                Name = myInfo["id"],
////
////                ImageURL = myPicture["data"]["url"]
////            };
//
//
//
...
//        }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Lay thong tin khac tu facebook 
                var access_token = claimsIdentity.FindAll("FacebookAccessToken").First().Value;
                var fb = new FacebookClient(access_token);
                dynamic myInfo = fb.Get("/me");
                //                dynamic fbBirthday = fb.Get("me?fields=birthday");
                //                string birthday = fbBirthday["birthday"];
                ...
                string ImageURL = myPicture["data"]["url"];
          
                //het
                string name = myInfo["name"];
                var user = new ApplicationUser { UserName = name, Email = model.Email,ImageUrl = ImageURL};
